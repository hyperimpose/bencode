...
-module(bencode).
-compile([{inline, [d/2, d_list/2, d_dict/2, d_int/3, d_str/3, d_next/3,
                    e/1, e_map/1]}]).

%% API
-export([decode/1, encode/1]).
-export_type([blist/0, bdict/0]).

%%====================================================================
%% Types
%%====================================================================

-opaque blist() :: [binary() | integer() | blist() | bdict()].
-opaque bdict() :: #{binary() => binary() | integer() | blist() | bdict()}.

%%====================================================================
%% API
%%====================================================================

-spec decode(Input :: iodata()) -> binary() | integer() | blist() | bdict().
decode(Input) -> d(iolist_to_binary(Input), []).

-spec encode(Input :: binary() | integer() | blist() | bdict()) -> iodata().
